...
Kingdom.prototype.getKingdomsList = async function (lang){
      try{
            let request = 'SELECT * FROM kingdoms WHERE lang = $1';
...
Kingdom.prototype.upsertKingdomsList = async function(payload){
      try{
            let request = `INSERT INTO kingdoms(id, lang, kingdom_name, short_name) VALUES($1, $2, $3, $4)\n
                           ON CONFLICT (id, lang)\n 
                           DO UPDATE SET id = $1, lang = $2, kingdom_name = $3, short_name = $4`;
